...
namespace Llc.GoodConsulting.Util.Extensions
{
    ...
    /// 
    /// </summary>
    public static class YesNoLocalization
    {
        const string Resources = nameof(Resources);
        const string YesNo = nameof(YesNo);

        static readonly ResourceManager _rm = new($"{nameof(Llc)}.{nameof(GoodConsulting)}.{nameof(Util)}.{nameof(Extensions)}.{Resources}.{YesNo}",
